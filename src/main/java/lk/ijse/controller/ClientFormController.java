...
public class ClientFormController implements Initializable {
    ...
    @FXML
    void clsBtnOnAction(MouseEvent event) throws IOException {
    ...
    @FXML
    void imgBtnOnAction(MouseEvent event) throws IOException {
    ...
    @FXML
    void sendMsgOnAction(ActionEvent event) throws IOException {
    ...
    private void setName() {
        usrNameTxt.setText(LoginController.userName);
    }
}
